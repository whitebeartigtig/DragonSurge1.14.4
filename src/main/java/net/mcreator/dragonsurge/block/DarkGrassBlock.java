...
public class DarkGrassBlock extends DragonSurgeElements.ModElement {
	@ObjectHolder("dragonsurge:darkgrass")
	public static final Block block = null;
	public DarkGrassBlock(DragonSurgeElements instance) {
		super(instance, 131);
	}

...
public class RubyOreBlockBlock extends DragonSurgeElements.ModElement {
	@ObjectHolder("dragonsurge:rubyoreblock")
	public static final Block block = null;
	public RubyOreBlockBlock(DragonSurgeElements instance) {
		super(instance, 17);
	}

...
public class YellowOreBlockBlock extends DragonSurgeElements.ModElement {
	@ObjectHolder("dragonsurge:yelloworeblock")
	public static final Block block = null;
	public YellowOreBlockBlock(DragonSurgeElements instance) {
		super(instance, 111);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("yelloworeblock");
		}

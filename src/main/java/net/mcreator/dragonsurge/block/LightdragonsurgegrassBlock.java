...
public class LightdragonsurgegrassBlock extends DragonSurgeElements.ModElement {
	@ObjectHolder("dragonsurge:lightdragonsurgegrass")
	public static final Block block = null;
	public LightdragonsurgegrassBlock(DragonSurgeElements instance) {
		super(instance, 135);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightdragonsurgegrass");
		}

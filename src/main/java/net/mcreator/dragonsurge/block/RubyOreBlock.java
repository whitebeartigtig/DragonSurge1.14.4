...
import net.mcreator.dragonsurge.item.RubyIngotItem;
...
public class RubyOreBlock extends DragonSurgeElements.ModElement {
	@ObjectHolder("dragonsurge:rubyore")
	public static final Block block = null;
	public RubyOreBlock(DragonSurgeElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RubyIngotItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("rubyore", "rubyore", blockAt -> {

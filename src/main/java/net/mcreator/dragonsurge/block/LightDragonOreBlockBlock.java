...
public class LightDragonOreBlockBlock extends DragonSurgeElements.ModElement {
	@ObjectHolder("dragonsurge:lightdragonoreblock")
	public static final Block block = null;
	public LightDragonOreBlockBlock(DragonSurgeElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightdragonoreblock");
		}

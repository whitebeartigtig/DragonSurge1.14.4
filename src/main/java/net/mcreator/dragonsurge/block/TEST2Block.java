...
public class TEST2Block extends DragonSurgeElements.ModElement {
	@ObjectHolder("dragonsurge:test2")
	public static final Block block = null;
	public TEST2Block(DragonSurgeElements instance) {
		super(instance, 168);
	}

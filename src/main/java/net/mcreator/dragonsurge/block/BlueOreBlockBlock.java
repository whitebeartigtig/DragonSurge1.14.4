...
public class BlueOreBlockBlock extends DragonSurgeElements.ModElement {
	@ObjectHolder("dragonsurge:blueoreblock")
	public static final Block block = null;
	public BlueOreBlockBlock(DragonSurgeElements instance) {
		super(instance, 90);
	}

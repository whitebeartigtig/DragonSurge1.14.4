...
import net.mcreator.dragonsurge.item.LightDragonGemItem;
...
public class LightDragonOreBlock extends DragonSurgeElements.ModElement {
	@ObjectHolder("dragonsurge:lightdragonore")
	public static final Block block = null;
	public LightDragonOreBlock(DragonSurgeElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("lightdragonore");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(LightDragonGemItem.block, (int) (1)));
		}
	}
	@Override
	public void init(FMLCommonSetupEvent event) {
		for (Biome biome : ForgeRegistries.BIOMES.getValues()) {
			...
			}, new OreFeatureConfig(OreFeatureConfig.FillerBlockType.create("lightdragonore", "lightdragonore", blockAt -> {

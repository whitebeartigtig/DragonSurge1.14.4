...
public class DarkDragonSurgePortalRoomStructure extends DragonSurgeElements.ModElement {
	public DarkDragonSurgePortalRoomStructure(DragonSurgeElements instance) {
		super(instance, 86);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 3) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) iworld.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("dragonsurge", "darkdragonsurgeportalfixed1"));
						if (template == null)
							return false;

...
public class LapuisArmorItem extends DragonSurgeElements.ModElement {
	@ObjectHolder("dragonsurge:lapuisarmorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("dragonsurge:lapuisarmorbody")
	public static final Item body = null;
	@ObjectHolder("dragonsurge:lapuisarmorlegs")
	public static final Item legs = null;
	@ObjectHolder("dragonsurge:lapuisarmorboots")
	public static final Item boots = null;
	public LapuisArmorItem(DragonSurgeElements instance) {
		super(instance, 147);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(DragonSurgeStuffItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "dragonsurge:textures/models/armor/lapuis_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("lapuisarmorhelmet"));
		...
		}.setRegistryName("lapuisarmorbody"));
		...
		}.setRegistryName("lapuisarmorlegs"));
		...
		}.setRegistryName("lapuisarmorboots"));
	}
}

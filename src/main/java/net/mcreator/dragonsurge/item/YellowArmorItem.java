...
public class YellowArmorItem extends DragonSurgeElements.ModElement {
	@ObjectHolder("dragonsurge:yellowarmorhelmet")
	public static final Item helmet = null;
	@ObjectHolder("dragonsurge:yellowarmorbody")
	public static final Item body = null;
	@ObjectHolder("dragonsurge:yellowarmorlegs")
	public static final Item legs = null;
	@ObjectHolder("dragonsurge:yellowarmorboots")
	public static final Item boots = null;
	public YellowArmorItem(DragonSurgeElements instance) {
		super(instance, 126);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(DragonSurgeStuffItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "dragonsurge:textures/models/armor/yellow_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("yellowarmorhelmet"));
		...
		}.setRegistryName("yellowarmorbody"));
		...
		}.setRegistryName("yellowarmorlegs"));
		...
		}.setRegistryName("yellowarmorboots"));
	}
}

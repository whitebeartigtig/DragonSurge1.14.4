...
public class RubyIngotItem extends DragonSurgeElements.ModElement {
	@ObjectHolder("dragonsurge:rubyingot")
	public static final Item block = null;
	public RubyIngotItem(DragonSurgeElements instance) {
		super(instance, 18);
	}

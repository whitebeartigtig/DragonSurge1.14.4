...
public class Boss1testEntity extends DragonSurgeElements.ModElement {
	public static EntityType entity = null;
	public Boss1testEntity(DragonSurgeElements instance) {
		super(instance, 163);
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.8f)).build("boss1test")
						.setRegistryName("boss1test");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("boss1test"));
	}
